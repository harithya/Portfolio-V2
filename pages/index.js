...
// import home from "../constant/home.json";
...
export async function getServerSideProps() {
  return {
    redirect: {
      destination:
        "https://ahead-garden-5cf.notion.site/2182319bd073809ca35fc49604aa9b55",
      permanent: false, // atau true jika kamu ingin redirect permanen (SEO)
    },
  };
}
