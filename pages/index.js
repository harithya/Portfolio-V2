    ...
    <div className='h-screen -mt-32 xl:mt-0 mb-10 xl:mb-0 flex xl:items-center xl:flex-row flex-col-reverse'>
      ...
      <div className='xl:w-6/12'>
        ...
        <p className='text-center xl:text-left'>Lihat
          ...
          </Link> dan juga <a href='https://drive.google.com/file/d/14ZV3-x0KaWJhziEF_QitmSf6D4uRRYPA/view?usp=sharing' target={"_blank"} rel="noopener"><span className='font-semibold underline'>Unduh CV Saya</span></a></p>
      </div>
